...
import homeHover from '../../assets/nav/home_hover.svg';
import writeHistory from '../../assets/nav/writehistory.svg';
import writeHistoryHover from '../../assets/nav/writehistory_hover.svg';
import shop from '../../assets/nav/shop.svg';
import shopHover from '../../assets/nav/shop_hover.svg';
import mypage from '../../assets/nav/mypage.svg';
import mypageHover from '../../assets/nav/mypage_hover.svg';
  ...
  return (
    <nav
      className={`
        ...
        bg-white/90 backdrop-blur border-t border-[#f2f3f5]
