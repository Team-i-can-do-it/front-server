...
export default function MicPanel({
  ...
  return (
    <section className="fixed inset-x-0 bottom-0 z-50 bg-white-base">
      <div className="mx-auto w-full max-w-[var(--mobile-w,390px)] px-6 py-[33px] border-t border-border-25">
